...
(function(Scratch) {
    'use strict';
    console.log("Loaded PenguinAI v1.93 by MubiLop (https://mubilop.tech/)")
    ...
    let api_url = 'https://proxy.mubilop.tech/v1';
    const vm = Scratch.vm;
    class PenguinGPT {
        ...
        setApiUrl(args) {
            ...
            api_url = newApiUrl;
            this.fetchAndGetReqModels().then(models => { // refresh model list
                this.reqModels = models
            });
        }
